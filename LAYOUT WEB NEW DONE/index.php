...
// Function untuk generate link
function generateLink($url, $text) {
    if (isLoggedIn()) {
        return '<a href="' . $url . '">' . $text . '</a>';
    } else {
        return '<a href="login.php?error=login_required">' . $text . '</a>';
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="container navbar">
      ...
      <nav>
        <ul>
          ...
          <li><?= generateLink('kopi.php', 'Kopi') ?></li>
          <li><?= generateLink('menu.php', 'Menu') ?></li>
          <li><?= generateLink('tentang_kami.php', 'Tentang Kami') ?></li>
          <li><?= generateLink('kontak.php', 'Kontak') ?></li>
  ...
  <section class="section about">
    <div class="container about-grid">
      <div class="about-text">
        ...
        <?php else: ?>
          <a href="login.php?error=login_required" class="btn">Selengkapnya</a>
        <?php endif; ?>
      </div>
